...
export default function Contact() {
  return (
    ...
    <div>
        ...
        <h2 className="absolute text-6xl top-56 w-full text-white font-serif text-center ">Contact Us</h2>
      </div>
...
>
  ...
  <input className=' border-2 w-full border-gray-300 p-2' type='text' autoComplete='off' placeholder='Name' name='name'/>
  </div>
  <div className='flex items-center'>
  ...
  <input className=' border-2 w-full border-gray-300 p-2' autoComplete='off' type='text' placeholder='Message' name='Message'/>
  </div>
