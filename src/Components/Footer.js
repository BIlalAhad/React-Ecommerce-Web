...
export default function Footer() {
  return (
    <>
    <section className='bg-blue-950 relative text-white p-16'>
        
        <div className='grid grid-flow-col grid-cols-4 gap-10 mb-7 '>
            <div>
                <h2 className='text-3xl font-bold mb-5'>Ecommerce </h2>
