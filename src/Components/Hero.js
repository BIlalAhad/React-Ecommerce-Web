...
export default function Hero() {
  return (
    <div>
      <section className='max-w-5xl mx-auto grid grid-flow-col grid-cols-2 gap-8 items-center '>
        <div>
            <span className='text-sm text-blue-800'>Welcome to</span>
            <h1 className='font-bold text-4xl font-serif mb-2'>Ecommerce Shop</h1>
